...
function PaymentForm() {
  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden  bg-[#daf5ffe3]" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center center',opacity:1 }}>
        ...
        <div className="mb-2">
            ...
            <input type="number" placeholder='xxxx-xxxx-xxxx-xxxx' className='block w-full h-[40px] px-4 py-2 mt-2 text-gray-800 bg-gray-100 border-black rounded-md focus:border-black-600 focus:ring focus:ring-opacity-40 ' value={cardNumber}   onChange={handleCardNumberChange} required/>
        </div>
        <div className="mb-2">
            <label for="cardName" className='block text-base font-semibold text-gray-800'>Cardholder Name</label>
            <input type="text" className='block w-full h-[40px] px-4 py-2 mt-2 text-gray-800 bg-gray-100 border-black rounded-md focus:border-black-600 focus:ring focus:ring-opacity-40' value={cardName}   onChange={handleCardNameChange} required/>
        </div>
        <div className="mb-2">
            <label for="cardExpiry" className='block text-base font-semibold text-gray-800'>Expiry Date</label>
            <input type="date" className='block w-full h-[40px] px-4 py-2 mt-2 text-gray-800 bg-gray-100 border-black rounded-md focus:border-black-600 focus:ring focus:ring-opacity-40' value={cardExpiry}   onChange={handleCardExpiryChange} required/>
        </div>
        <div className="mb-2">
            <label for="cardCvc" className='block text-base font-semibold text-gray-800'>CVC</label>
            <input type="text" placeholder='123' className='block w-full h-[40px] px-4 py-2 mt-2 text-gray-800 bg-gray-100 border-black rounded-md focus:border-black-600 focus:ring focus:ring-opacity-40' value={cardCvc}   onChange={handleCardCvcChange} required/>
        </div>
        <div className='mb-2'>
  ...
  <div className="relative">
    ...
    <input
      type="number"
      className='pl-10 block w-full h-[40px] px-4 py-2 mt-2 text-gray-800 bg-gray-100 border-black rounded-md focus:border-black-600 focus:ring focus:ring-opacity-40'
